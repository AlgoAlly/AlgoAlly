  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-8">
      ...
      <div className="w-full max-w-4xl space-y-2">
        {/* Problem List Header */}
        <div className="grid grid-cols-4 gap-4 px-6 py-4 bg-bg-active rounded-t-lg shadow-md font-bold mb-2 text-text-primary">
        ...
        {problems.map((problem) => (
          <div
            key={problem.id}
            className="grid grid-cols-4 gap-4 px-6 py-2 bg-bg-secondary border-b border-border-primary hover:bg-bg-active transition rounded-md shadow-sm"
          >
            {/* ID */}
            ...
            <div className="text-left overflow-hidden">
              <div className="inline-block animate-marquee-hover align-middle">
                {problem.name}
              </div>
            </div>
